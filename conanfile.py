...
class KirigamiConan(ConanFile):
    ...
    def source(self):
        ...
        tools.replace_in_file(os.path.join("kirigami-v%s" % self.version, "templates", "CMakeLists.txt"), "kde_package_app_templates(TEMPLATES ${apptemplate_DIRS} INSTALL_DIR ${KDE_INSTALL_KTEMPLATESDIR})", "")
